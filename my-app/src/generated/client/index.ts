...
export const ColmapScalarFieldEnumSchema = z.enum(['id','sheet_id','label','pos']);

export const QueryModeSchema = z.enum(['default','insensitive']);

export const RowmapScalarFieldEnumSchema = z.enum(['id','sheet_id','label','pos']);

export const SheetsScalarFieldEnumSchema = z.enum(['id','rows','cols','created_at','title']);
...
export const ColmapSchema = z.object({
  ...
  pos: z.number().int().gte(-32768).lte(32767),
})
...
export const ColmapWhereInputSchema: z.ZodType<Prisma.ColmapWhereInput> = z.object({
  ...
  pos: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
...
export const ColmapScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ColmapScalarWhereWithAggregatesInput> = z.object({
  ...
  pos: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
}).strict();
...
export const ColmapUpdateInputSchema: z.ZodType<Prisma.ColmapUpdateInput> = z.object({
  ...
  pos: z.union([ z.number().int().gte(-32768).lte(32767),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ColmapUpdateWithoutCellmapInputSchema: z.ZodType<Prisma.ColmapUpdateWithoutCellmapInput> = z.object({
  id: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  label: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  pos: z.union([ z.number(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  sheets: z.lazy(() => SheetsUpdateOneRequiredWithoutColmapNestedInputSchema).optional()
}).strict();
